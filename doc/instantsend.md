...
This mechanism has been integrated into Bitcore-Node-Flash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/pmo24/insight-api-flash#web-socket-api](https://github.com/pmo24/insight-api-flash#web-socket-api) 
* API: [https://github.com/pmo24/insight-api-flash#instantsend-transactions](https://github.com/pmo24/insight-api-flash#instantsend-transactions) 
...
By default, the Flash Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Flash Core daemon:
