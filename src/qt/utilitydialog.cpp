    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Flash Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Flash Core"));
...
All the Flash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 FLASH, 0.1 FLASH, 1 FLASH and 10 FLASH -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://pmo24.atlassian.net/wiki/display/DOC/PrivateSend\">https://pmo24.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Flash Core is shutting down...") + "<br /><br />" +
