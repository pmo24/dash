    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("FLASH-light"), QVariant("light"));
    ui->theme->addItem(QString("FLASH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("FLASH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("FLASH-traditional"), QVariant("trad"));
