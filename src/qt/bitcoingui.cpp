    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Flash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Flash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and flash: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Flash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Flash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Flash Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Flash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Flash addresses"));
    ...
    openAction->setStatusTip(tr("Open a flash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Flash Core help message to get a list with possible Flash Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Flash Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Flash Core"); // default title
