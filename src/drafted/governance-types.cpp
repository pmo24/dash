...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "FlashNetwork") type = FlashNetwork;
    if(strType == "FlashNetworkVariable") type = FlashNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == FlashNetwork) s = "FlashNetwork";
    if(type == FlashNetworkVariable) s = "FlashNetworkVariable";
