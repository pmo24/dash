 ...
 *
 *   // network
 *   CFlashNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.flash.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CFlashNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: FlashNetwork
// //   -- signature requirements : Key1(User)
// class CFlashNetworkVariable : public CGovernanceObject
// {
// private:
