...
{
    if(fLiteMode) return; // ignore all Flash related functionality
...
/*
    ...
    allow endless transaction that would bloat Flash and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("flash-privatesend");
